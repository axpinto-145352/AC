#!/usr/bin/env python3
"""Convert all markdown documents to styled PDF files."""
...
@page {
    ...
    margin: 1in;
    @bottom-center {
        content: "VETERAN VECTORS | Authentic Consortium | PROJ00628";
        font-size: 8pt;
        color: #999;
...
# Convert all markdown documents
docs = [
    ("01_Go_No_Go_Report.md", "01_Go_No_Go_Report.pdf"),
    ("02_Software_Action_Plan.md", "02_Software_Action_Plan.pdf"),
...
print("\nAll markdown documents converted to PDF.")
